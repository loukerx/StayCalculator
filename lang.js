const TRANSLATIONS = {
  zh: {
    ...
    errorExitBeforeEntry: '出入境记录中离境日期必须晚于入境日期。',
  ...
  'zh-TW': {
    ...
    errorExitBeforeEntry: '出入境紀錄中離境日期必須晚於入境日期。',
  ...
  ja: {
    ...
    errorExitBeforeEntry: '出入国記録の出国日は入国日より後でなければなりません。',
  ...
  hi: {
    ...
    errorExitBeforeEntry: 'यात्रा रिकॉर्ड में प्रस्थान तिथि प्रवेश तिथि के बाद होनी चाहिए।',
  ...
  id: {
    ...
    errorExitBeforeEntry: 'Tanggal keluar harus lebih lambat dari tanggal masuk dalam catatan perjalanan.',
  ...
  vi: {
    ...
    errorExitBeforeEntry: 'Ngày xuất cảnh phải sau ngày nhập cảnh trong bản ghi xuất nhập cảnh.',
  ...
  fil: {
    ...
    errorExitBeforeEntry: 'Ang petsa ng pag-alis ay dapat pagkatapos ng petsa ng pagpasok sa mga tala ng paglalakbay.',
  ...
  th: {
    ...
    errorExitBeforeEntry: 'วันที่ออกจากประเทศต้องหลังจากวันที่เข้าประเทศในรายการเดินทาง',
  ...
  ko: {
    ...
    errorExitBeforeEntry: '출입국 기록에서 출국일은 입국일보다 늦어야 합니다.',
  ...
  en: {
    ...
    errorExitBeforeEntry: 'Exit date must be later than entry date in travel records.',
